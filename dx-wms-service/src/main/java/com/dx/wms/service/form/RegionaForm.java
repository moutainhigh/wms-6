 ...
 * FileName: RegionalReportManagementServiceImpl.java
 * Author:   张祥韵
 ...
 */
@Service
public class RegionaForm extends FormRegister {

    /**
     * 日志组件
     */
    private static final Logger LOG = LoggerFactory.getLogger(RegionaForm.class);

    @Override
    public String init(Map<String, Object> param) {
        return "reportManagement/arealist";
    }
    ...
    public Boolean supports(Map<String, Object> param) {
        ...
        return commonService.hasRoleExist(roleVos, RoleConstant.QYJL);
    }
    ...
    public PaginationResult<List<FormDto>> query(Map<String, Object> param, Pagination page) {
        ...
        return dalClient.queryForList("reportManagement.areaQueryForPage",
    ...
    public List<FormDto> getExcelVos(Map<String, Object> param) {
        ...
        List<FormDto> reportManagementDtos = dalClient.queryForList("reportManagement.areaQueryForPage",
    ...
    public void queryExcel(Map<String, Object> param) {
        ...
        List<String> skipvalueList = new ArrayList<String>();
        ...
        for (int i = 0; i < skipvalueList.size(); i++) {
            for (int j = 0; j < titleList.size(); j++) {
                if (skipvalueList.get(i).equals(titleList.get(j))) {
                    titleList.remove(j);
                }
            }
        }
    ...
    public Map<String, Object> getRequestMap(Map<String, Object> param) {
        ...
        String areaOrgIds = orgVo.getOrgId().toString();
    ...
    public FormParamVo getManagementQueryVo(Map<String, Object> param) {
        ...
        reportManagementQueryVo.setAreaOrgIds(orgVo.getOrgId());
