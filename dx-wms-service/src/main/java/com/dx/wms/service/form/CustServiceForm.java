 ...
 * FileName: CustomenrServiceReportManagementServiceImpl.java
 * Author:   张祥韵
 ...
 */
@Service
public class CustServiceForm extends FormRegister {

    /**
     * 日志组件
     */
    private static final Logger LOG = LoggerFactory.getLogger(CustServiceForm.class);

    @Override
    public String init(Map<String, Object> param) {
        return "reportManagement/customenrservicelist";
    }
    ...
    public Boolean supports(Map<String, Object> param) {
        ...
        return commonService.hasRoleExist(roleVos, RoleConstant.XSKF);
    }
    ...
    public PaginationResult<List<FormDto>> query(Map<String, Object> param, Pagination page) {
        ...
        return dalClient.queryForList("reportManagement.customenrServiceQueryForPage",
    ...
    public List<FormDto> getExcelVos(Map<String, Object> param) {
        ...
        String orgVoIdQuery = request.getParameter("orgVoIdQuery");
        if (Assert.checkParam(orgVoIdQuery)) {
            reportManagementQueryDto.setOrgId(Long.parseLong(orgVoIdQuery));
        }
        ...
        List<FormDto> reportManagementDtos = dalClient.queryForList(
                "reportManagement.customenrServiceQueryForPage", reportManagementQueryDto, FormDto.class);
    ...
    public void queryExcel(Map<String, Object> param) {
        ...
        String wmsTopClass = commonService
                .queryOrgCache(commonService.queryOrgCache(orgVo.getParentId(), orgMap).getParentId(), orgMap).getName()
                + commonService.queryOrgCache(orgVo.getParentId(), orgMap).getName() + orgVo.getName();
        ...
        if (Assert.checkParam(reportManagermentExcelDto.getCreateUser())) {
            title.add("客户经理:" + reportManagermentExcelDto.getCreateUser());
        } else {
            title.add("客户经理:");
        }
        String begtime = "";
    ...
    public Map<String, Object> getRequestMap(Map<String, Object> param) {
        ...
        String orgId = orgVo.getOrgId().toString();
        ...
        map.put("orgVoIdQuery", orgVoIdQuery);
    ...
    public FormParamVo getManagementQueryVo(Map<String, Object> param) {
        ...
        reportManagementQueryVo.setOrgId(reportManagementQueryVo.getOrgVoIdQuery());
    ...
    public FormDto queryallLenderAmount(Map<String, Object> param) {
        ...
        LOG.info("**queryallLenderAmount() reportManagementQueryDto={}**", new Gson().toJson(reportManagementQueryDto));
        List<FormDto> reportManagementDtos = dalClient.queryForList(
                "reportManagement.customenrServiceQueryForPage", reportManagementQueryDto, FormDto.class);
