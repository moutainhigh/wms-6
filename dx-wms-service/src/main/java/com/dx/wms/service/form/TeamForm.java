 ...
 * FileName: TeamReportManagementServiceImpl.java
 * Author:   张祥韵
 ...
 */
@Service
public class TeamForm extends FormRegister {

    /**
     * 日志组件
     */
    private static final Logger LOG = LoggerFactory.getLogger(TeamForm.class);

    @Override
    public String init(Map<String, Object> param) {
        return "reportManagement/teamlist";
    }
    ...
    public Boolean supports(Map<String, Object> param) {
        ...
        return commonService.hasRoleExist(roleVos, RoleConstant.TDJL);
    }
    ...
    public PaginationResult<List<FormDto>> query(Map<String, Object> param, Pagination page) {
        ...
        return dalClient.queryForList("reportManagement.smallTeamQueryForPage",
    ...
    public List<FormDto> getExcelVos(Map<String, Object> param) {
        ...
        List<FormDto> reportManagementDtos = dalClient.queryForList(
                "reportManagement.smallTeamQueryForPage", reportManagementQueryDto, FormDto.class);
    ...
    public Map<String, Object> getRequestMap(Map<String, Object> param) {
        ...
        String teamId = orgVo.getOrgId().toString();
    ...
    public FormParamVo getManagementQueryVo(Map<String, Object> param) {
        ...
        reportManagementQueryVo.setTeamId(orgVo.getOrgId());
