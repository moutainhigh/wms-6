...
@Service("professionSaveHandler")
public class ProfessionSaveHandler extends SaveHandler<ParamSaver, HandlerDto, ResultSaver> {
    ...
    public void handleSaveRequest(ParamSaver condition, HandlerDto dto, ResultSaver result) {
        custAccountService.saveProfession(condition.getProfession(), dto, result);
