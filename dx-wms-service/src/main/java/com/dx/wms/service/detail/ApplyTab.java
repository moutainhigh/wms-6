...
public enum ApplyTab {
    ...
    ACCOUNT("tab_detail_account", "active", "账户信息", "detail/account.ftl", 4),

    APPLY("tab_detail_apply", "", "投资信息", "detail/apply.ftl", 3),

    VIDEO("tab_detail_video", "", "影像信息", "detail/video.ftl", 2),
    
    LOG("tab_detail_slog", "", "日志信息", "detail/log.ftl", 1);
