 ...
 * FileName: SalesDepartmentReportManagementServiceImpl.java
 * Author:   张祥韵
 ...
 */
@Service
public class DepartmentManagerForm extends FormRegister {

    /**
     * 日志组件
     */
    private static final Logger LOG = LoggerFactory.getLogger(DepartmentManagerForm.class);

    @Override
    public String init(Map<String, Object> param) {
        return "reportManagement/orglist";
    }
    ...
    public Boolean supports(Map<String, Object> param) {
        ...
        return commonService.hasRoleExist(roleVos, RoleConstant.YYBJL);
    }
    ...
    public PaginationResult<List<FormDto>> query(Map<String, Object> param, Pagination page) {
        ...
        return dalClient.queryForList("reportManagement.salesDepartmentQueryForPage",
    ...
    public List<FormDto> getExcelVos(Map<String, Object> param) {
        ...
        List<FormDto> reportManagementDtos = dalClient.queryForList(
                "reportManagement.salesDepartmentQueryForPage", reportManagementQueryDto, FormDto.class);
    ...
    public FormParamVo getManagementQueryVo(Map<String, Object> param) {
        ...
        reportManagementQueryVo.setOrgId(orgVo.getOrgId());
