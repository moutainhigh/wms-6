 ...
 * FileName: ClusterReportManagementServiceImpl.java
 * Author:   张祥韵
 ...
 */
@Service
public class ClusterForm extends FormRegister {

    /**
     * 日志组件
     */
    private static final Logger LOG = LoggerFactory.getLogger(ClusterForm.class);

    @Override
    public String init(Map<String, Object> param) {
        return "reportManagement/clusterlist";
    }
    ...
    public Boolean supports(Map<String, Object> param) {
        ...
        return commonService.hasRoleExist(roleVos, RoleConstant.DTJL);
    }
    ...
    public PaginationResult<List<FormDto>> query(Map<String, Object> param, Pagination page) {
        ...
        return dalClient.queryForList("reportManagement.bigTeamQueryForPage",
    ...
    public List<FormDto> getExcelVos(Map<String, Object> param) {
        ...
        List<FormDto> reportManagementDtos = dalClient.queryForList("reportManagement.bigTeamQueryForPage",
    ...
    public void queryExcel(Map<String, Object> param) {
        ...
        String wmsTopClass = commonService
                ...
                .getName() + commonService.queryOrgCache(preantOrgVo.getParentId(), orgMap).getName()
    ...
    public Map<String, Object> getRequestMap(Map<String, Object> param) {
        ...
        String cluster = orgVo.getOrgId().toString();
    ...
    public FormParamVo getManagementQueryVo(Map<String, Object> param) {
        ...
        reportManagementQueryVo.setCluster(orgVo.getOrgId());
