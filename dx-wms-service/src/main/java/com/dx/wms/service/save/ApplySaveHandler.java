...
@Service("applySaveHandler")
public class ApplySaveHandler extends SaveHandler<ParamSaver, HandlerDto, ResultSaver> {
    ...
    public void handleSaveRequest(ParamSaver condition, HandlerDto dto, ResultSaver result) {
        lenderApplySaveService.saveAppy(condition.getApply(), dto, result);
