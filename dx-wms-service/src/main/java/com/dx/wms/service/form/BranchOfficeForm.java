 ...
 * FileName: BranchOfficeReportManagementServiceImpl.java
 * Author:   张祥韵
 ...
 */
@Service
public class BranchOfficeForm extends FormRegister {

    /**
     * 日志组件
     */
    private static final Logger LOG = LoggerFactory.getLogger(BranchOfficeForm.class);

    @Override
    public String init(Map<String, Object> param) {
        return "reportManagement/branchofficelist";
    }
    ...
    public Boolean supports(Map<String, Object> param) {
        ...
        return commonService.hasRoleExist(roleVos, RoleConstant.FGSJL);
    }
    ...
    public PaginationResult<List<FormDto>> query(Map<String, Object> param, Pagination page) {
        ...
        return dalClient.queryForList("reportManagement.branchOfficeQueryForPage",
    ...
    public List<FormDto> getExcelVos(Map<String, Object> param) {
        ...
        List<FormDto> reportManagementDtos = dalClient.queryForList(
                "reportManagement.branchOfficeQueryForPage", reportManagementQueryDto, FormDto.class);
    ...
    public void queryExcel(Map<String, Object> param) {
        ...
        String wmsTopClass = commonService.queryOrgCache(orgVo.getParentId(), orgMap).getName() + orgVo.getName();
    ...
    public Map<String, Object> getRequestMap(Map<String, Object> param) {
        ...
        String branchOfficeId = orgVo.getOrgId().toString();
    ...
    public FormParamVo getManagementQueryVo(Map<String, Object> param) {
        ...
        reportManagementQueryVo.setBranchOfficeIds(orgVo.getOrgId());
