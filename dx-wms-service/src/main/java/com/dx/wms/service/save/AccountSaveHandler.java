...
@Service("accountSaveHandler")
public class AccountSaveHandler extends SaveHandler<ParamSaver,HandlerDto,ResultSaver> {
    ...
    public void handleSaveRequest(ParamSaver condition,HandlerDto dto,ResultSaver result) {
        custAccountService.saveAccount(condition.getAccount(), dto,result);
