...
public class DubboTests extends BaseTest {
    ...
    public void productService() {
        System.out.println(productService.getProductByAppAndProductId("ccs", 1L));
    }

    @Test
    public void settle() {
        PushData data = new PushData();
        data.setBizCode("DXC1605911003546");
        matchPushService.push(MatchPushCode.CREDIT_SETTLE, data);
    }
}
