 ...
 *
 */
public class ExcEffectResult implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -6142738989793368405L;
    ...
    public ExcEffectResult(InvestResult invest, ILenderApplyService lenderApplyService, IAMService amService,
            final Map<Long, String> product){
        
    }
    
    public ExcEffectResult(){
