 ...
 * @author tony
 */
public class FirstViewResult extends InvestResult {

    /**
     */
    private static final long serialVersionUID = -121577192649749289L;
	...
	public void parse(BigDecimal capital, BigDecimal interest, IProductService productService,
        ...
        setEffectTimeView(Assert.checkParam(getEffectTime()) ? DateUtils.formatForDay(getEffectTime()) : "-");
        setResults(results);
    }
