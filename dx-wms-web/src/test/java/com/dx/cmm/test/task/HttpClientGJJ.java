...
public class HttpClientGJJ {



	public static void main(String[] args){
		 String url = "https://www.juxinli.com/api/access_house_fund_raw_data";
		 ...
		 params.add(new BasicNameValuePair("token", "12b015a2cec643f49cda3b5f124358f1"));
		 String str = "";
		 try {  
