...
public class HttpClientGetReportData {
/**
 * 报告	
*/	
	public static void main(String[] args){
		 ...
		 params.add(new BasicNameValuePair("name", "包坚强"));
		 params.add(new BasicNameValuePair("phone", "15806278711"));
		 params.add(new BasicNameValuePair("idcard", "350127197010151679"));
		 String str = "";
		 try {  
