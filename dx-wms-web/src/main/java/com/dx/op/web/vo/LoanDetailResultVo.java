...
public class LoanDetailResultVo implements Serializable {
     ...
     * 还款期限（月）
     */
    private Integer approveDeadline;
     ...
     * 审批产品类型
     */
    private Integer approveProdType;
    ...
    public Integer getApproveDeadline() {
        return approveDeadline;
    }

    public void setApproveDeadline(Integer approveDeadline) {
    ...
    public Integer getApproveProdType() {
        return approveProdType;
    }

    public void setApproveProdType(Integer approveProdType) {
