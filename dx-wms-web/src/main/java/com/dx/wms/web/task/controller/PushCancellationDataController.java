...
@Controller
@RequestMapping("/pushCancellationData")
public class PushCancellationDataController extends StringEscapeSupportController {
    /**
     * 日志组件
     */
    private static final Logger LOG = LoggerFactory.getLogger(PushCancellationDataController.class);

    @Autowired
    private ILenderDestoryService dealCancellationDataService;

    @RequestMapping(value = "/pushCancellationData.html")
    public void pushCancellationData(@RequestParam("authCode") String authCode, HttpServletRequest req,
        ...
        try {
            ...
            retMap.put("nodeName", "pushCancellationData"); // 成功，返回nodeName
            ...
            retMap.put("errMsg", "pushCancellationData"); // 失败，返回nodeName
        } finally {
