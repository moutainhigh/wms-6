...
@Controller
@RequestMapping("/dealDueDate")
public class DealDueDateController extends StringEscapeSupportController {
    /**
     * 日志组件
     */
    private static final Logger LOG = LoggerFactory.getLogger(DealDueDateController.class);
    ...
    @RequestMapping(value = "/dealDueDate.html")
