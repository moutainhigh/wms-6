...
function showAccountInfo(custAccountId) {
	var url = base + '/process/applyPersonInfo.json?type=1'+'&custAccountId='
...
function showApplyInfo(custAccountId) {
	var url = base + '/process/applyInfo.json?custAccountId=' + custAccountId
...
function showVideoInfo(custAccountId) {
	var url = base + '/process/applyVideoInfo.json?custAccountId='
