...
var App = function () {
    ...
    // To get the correct viewport width based on  /andylangton.co.uk/articles/javascript/get-viewport-size-javascript/
    ...
    var handleResponsiveTables = function() {
        $('.table-responsive-scrollable').each(function() {
            var element = $(this);
            if (element.data('scrollWrapper')) {
    ...
    return {
        ...
        init: function () {
            ...
            handleResponsiveTables(); // handle responsive scrollable tables
