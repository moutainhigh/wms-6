			...
			.dataTable(
					{
						...
						"fnServerParams" : function(aoData) {
							aoData
									.push(
											...
											{ 
												"name": "transTimeBegin", 
												"value": $("#transTimeBegin").val()
											},
						       		 	    { 
												"name": "transTimeEnd", 
												"value": $("#transTimeEnd").val()
						       		 	    },
						       		 	    { 
						       		 	    	"name": "productId", 
						       		 	    	"value": $("#productId").val()
						...
						"aoColumns" : [
								...
								{
									"mData" : "serviceChargeView",
									"bSortable" : false,
									"sClass" : "txt-center",
									"sWidth" : "100px"
								},
								{
									"mData" : "accountFeeView",
									"bSortable" : false,
									"sClass" : "txt-center",
									"sWidth" : "100px"
								},
...
//								|| $( e.target ).closest(".dataTables_info").length != 0
	...
	$(".listReport").live(
			...
			function() {
				...
				*/
				...
				var url = base
						+ "/report/maturity/excelExoprt.json?"
						+ $("#queryForm").serialize();
	...
	$(".review").live("click",function() {
		$('#reportModal').html('');
		$.ajax({
				url : base+ "/report/past/preview.json?lenderCode="+ $(this).attr("data"),// 请求url
				type : "POST",
				async : false,
				dataType : "html",
