...
<div class="row-fluid">
	<div class="span5 responsive">
        ...
        <div class="controls">
        	<input type="text" class="medium m-wrap" name="custAccountId" id="custAccountId" value="${custAccountApplyVo.custAccount.lenderCustCode}" disabled />
        </div>
    </div>
	<div class="span5 responsive">
    	<label class="control-label">账户级别：</label>
      	<div class="controls">
        	<input type="text" class="medium m-wrap" name="accountLevelId" id="accountLevelId" value="" disabled />
        </div>
    </div>
 </div>      
 <div class="row-fluid">
 	<div class="span5 responsive">
    	<label class="control-label">姓名：</label>
       	<div class="controls">
        	<input type="text" class="medium  m-wrap" name="custName" id="custName" value="${custAccountApplyVo.custAccount.custName}" disabled />
        </div>
    </div>
    <div class="span5 responsive">
    	<label class="control-label">姓名(拼音)：</label>
        <div class="controls">
        	<input type="text" class="medium m-wrap" name="custNameSpell" id="custNameSpell" value="${custAccountApplyVo.custAccount.custNameSpell}" disabled />
        </div>
    </div>
</div>
<div class="row-fluid">
	<div class="span5 responsive">
        ...
        <div class="controls">
        	<select class="medium m-wrap" name="sex" id="sex" value="${custAccountApplyVo.custAccount.sex}" disabled>
            	<#if sex?exists>
    ...
    <div class="span5 responsive">
        ...
        <div class="controls">
        	<input type="text" class="medium m-wrap" name="nationality" id="nationality" value="中国" disabled />
        </div>
    </div>
</div>
<div class="row-fluid">
	<div class="span5 responsive">
        ...
        <div class="controls">
        	<select class="medium m-wrap" name="maritalStatus" id="maritalStatus" value="${custAccountApplyVo.custAccount.maritalStatus}" disabled>
    ...
    <div class="span5 responsive">
        ...
        <div class="controls">
        	<input type="text" class="medium m-wrap" name="commonLanguage" id="commonLanguage" value="中文" disabled/>
        </div>
    </div>
</div>
<div class="row-fluid">
	<div class="span5 responsive" >
        ...
        <div class="controls">
        	<select class="medium m-wrap" name="idType" id="idType" value="${custAccountApplyVo.custAccount.idType}" disabled>
	        	<#if idType?exists>
	...
	<div class="span5 responsive">
    	...
    	<div class="controls">
          	<input type="text" class="medium m-wrap" name="idCard" id="idCard" value="${custAccountApplyVo.custAccount.idCard}" disabled />
    	</div>
    </div>
</div>
<div class="row-fluid">
    <div class="span5 responsive">
        ...
        <div class="controls">
            <input type="text" class="medium m-wrap" name="birthDate" id="birthDate" value="<#if custAccountApplyVo.custAccount.birthDate?exists>${custAccountApplyVo.custAccount.birthDate?string("yyyy-MM-dd")}</#if>" disabled />
        </div>
    </div>
    <div class="span5 responsive">
        <label class="control-label">移动电话：</label>
        <div class="controls">
            <input type="text" class="medium m-wrap" name="mobile" id="mobile" value="${custAccountApplyVo.custAccount.mobile}" disabled />
        </div>
    </div>
</div>
<div class="row-fluid">
    <div class="span5 responsive">
        ...
        <div class="controls">
            <select class="medium m-wrap" name="profession" id="profession" value="${custAccountApplyVo.custProfession.profession}" disabled >
    ...
    <div class="span5 responsive">
        ...
        <div class="controls">
            <input type="text" class="medium m-wrap" name="industry" id="industry" value="${custAccountApplyVo.custProfession.industry}" disabled />
        </div>
    </div>
</div>
<div class="row-fluid">
    <div class="span5 responsive">
        ...
        <div class="controls">
            <input type="text" class="medium m-wrap" name="companyName" id="companyName" value="${custAccountApplyVo.custProfession.companyName}" disabled />
        </div>
    </div>
    <div class="span5 responsive">
        <label class="control-label">职位：</label>
        <div class="controls">
            <input type="text" class="medium m-wrap"  name="post" id="post" value="${custAccountApplyVo.custProfession.post}" disabled />
        </div>
    </div>
</div>
<div class="row-fluid">
    <div class="span5 responsive">
        ...
        <div class="controls">
            <select class="medium m-wrap" name="education" id="education" value="${custAccountApplyVo.custAccount.education}" disabled >
                <#if education?exists>
...
<div class="row-fluid">
    <div class="span5 responsive">
        ...
        <div class="controls">
            <input type="text" class="medium m-wrap"  name="zipCode" id="zipCode" value="${custAccountApplyVo.custComm.zipCode}">
        </div>
    </div>
    <div class="span5 responsive">
        ...
        <div class="controls">
            <div class="span4 responsive">
                <input type="text" class="medium m-wrap"  name="areaCode" id="areaCode" value="${custAccountApplyVo.custComm.areaCode}">
            </div>
            <div class="span1 responsive" style="line-height: 30px;">
             	- 
            </div>
            <div class="span6 responsive">
                <input type="text" class="medium m-wrap"  name="telNum" id="telNum" value="${custAccountApplyVo.custComm.telNum}">
            </div>
        </div>
    </div>
</div>
<div class="row-fluid">
    <div class="span6 responsive">
        ...
        <div class="controls">
            <input type="text" class="medium m-wrap" name="email" id="email" value="${custAccountApplyVo.custComm.email}" >
        </div>
    </div>
    <div class="span6 responsive"  style="margin-left: -20px;">
        <label class="control-label">微信号：</label>
        <div class="controls">
            <input type="text" class="medium m-wrap"  name="wechat" id="wechat" value="${custAccountApplyVo.custComm.wechat}" >
        </div>
    </div>
</div>
...
<div class="row-fluid">
    <div class="span6 responsive">
        ...
        <div class="controls">
            <input type="text" class="medium m-wrap"   name="linkmanName" id="linkmanName" value="${custAccountApplyVo.custLinkman.linkmanName}" >
        </div>
    </div>
    <div class="span6 responsive"  style="margin-left: -20px;">
        <label class="control-label">姓名(拼音)：</label>
        <div class="controls">
            <input type="text" class="medium m-wrap"  name="linkmanNameSpell" id="linkmanNameSpell" value="${custAccountApplyVo.custLinkman.linkmanNameSpell}" >
        </div>
    </div>
</div>
<div class="row-fluid">
    <div class="span6 responsive">
        ...
        <div class="controls">
            <select class="medium m-wrap" name="linkmanSex" id="linkmanSex" value="${custAccountApplyVo.custLinkman.linkmanSex}">
                <#if sex?exists>
                    <#list sex?keys as key>
    ...
    <div class="span6 responsive"  style="margin-left: -20px;">
        ...
        <div class="controls">
            <input type="text" class="medium m-wrap" name="linkmanRelation" id="linkmanRelation" value="${custAccountApplyVo.custLinkman.linkmanRelation}" >
        </div>
    </div>
</div>
<div class="row-fluid">
    <div class="span6 responsive">
        ...
        <div class="controls">
            <select class="medium m-wrap" name="linkmanIdType" id="linkmanIdType" value="${custAccountApplyVo.custLinkman.linkmanIdType}">
                <#if idType?exists>
                    <#list idType?keys as key>
    ...
    <div class="span6 responsive"  style="margin-left: -20px;">
        <label class="control-label">证件号码：</label>
        <div class="controls">
            <input type="text" class="medium m-wrap" name="linkmanIdCard" id="linkmanIdCard" value="${custAccountApplyVo.custLinkman.linkmanIdCard}">
        </div>
    </div>
</div>
<div class="row-fluid">
    <div class="span6 responsive">
        ...
        <div class="controls">
            <input type="text" class="medium m-wrap"  name="linkmanMobile" id="linkmanMobile" value="${custAccountApplyVo.custLinkman.linkmanMobile}" >
        </div>
    </div>
    <div class="span6 responsive"  style="margin-left: -9px;">
        <label class="control-label">固定电话：</label>
        <div class="controls">
            <div class="span4 responsive">
                <input type="text" class="medium m-wrap" name="linkmanAreaCode" id="linkmanAreaCode" value="${custAccountApplyVo.custLinkman.areaCode}" >
            </div>
            <div class="span1 responsive" style="line-height: 30px;">
             - 
            </div>
            <div class="span6 responsive">
                <input type="text" class="medium m-wrap" name="linkmanTelNum" id="linkmanTelNum" value="${custAccountApplyVo.custLinkman.telNum}" >
            </div>
        </div>
    </div>
</div>
...
<div class="row-fluid">
    <div class="span6 responsive">
        ...
        <div class="controls">
            <select class="medium m-wrap" name="msgWay" id="msgWay" value="${custAccountApplyVo.custAccount.msgWay}">
                <#if msgWay?exists>
...
<div class="row-fluid">
    <div class="span6 responsive">
        ...
        <div class="controls">
            <select class="medium m-wrap" name="custSource" id="custSource" value="${custAccountApplyVo.custAccount.custSource}">
    ...
    <div class="span6 responsive" id="custSourceOtherDiv" style="margin-left: -20px;">
        <label class="control-label">其他：<span class="required">*</span></label>
        <div class="controls">
            <input type="text" class="medium m-wrap" name="custSourceOther" id="custSourceOther" value="${custAccountApplyVo.custAccount.custSourceOther}" >
        </div>
    </div>
</div>
<div class="row-fluid">
    <div class="span6 responsive">
        ...
        <div class="controls">
            <select class="medium m-wrap" name="custCategory" id="custCategory" value="${custAccountApplyVo.custAccount.custCategory}">
