...
<div class="row-fluid">
	<@div title="出借金额(元)" required=true labelClass="w140" controlsClass="ml160" style="margin-left: 50px;">	
       	<#--<span class="rmb3" style="line-height: 40px;float:right;margin-top:-2px;">元</span>-->
...
<div class="row-fluid">
    <@div title="回收方式" required=true labelClass="w140" controlsClass="ml160" style="margin-left: 50px;">	
        <@select source=recoveryMode target=saver.apply.recovery name="recovery" class="span10"/>
    </@div>
    <@div title="签单日期" required=true labelClass="w140" controlsClass="ml160">	
...
<div class="row-fluid">
	<@div title="支付方式" required=true labelClass="w140" controlsClass="ml160" style="margin-left: 50px;">
        <@select source=payWay target=saver.apply.payWayId name="payWayId" id="payWayId" class="span10"/>
    </@div>
    <@div title="签约手机" required=true labelClass="w140" controlsClass="ml160" id="signMobileDiv">	
        <@text name="signMobile" id="signMobile" value=saver.apply.signMobile inline=true class="span10"/>
    </@div>
</div>                

<h4 class="form-section">支付账户信息 </h4>   
<div class="row-fluid">  
	<@div title="请选择省" required=true  labelClass="w140" controlsClass="ml160" style="margin-left: 50px;">	
        <@select source=areas target=saver.payFinanceVo.provinceRegionCode name="payProvinceRegionCode" id="payProvinceRegionCode" class="span10"/>
    </@div>
    <@div title="请选择市" required=true labelClass="w140" controlsClass="ml160" >	
		<select class="span10 m-wrap bank" name="payCityRegionCode" id="payCityRegionCode" value="${saver.payFinanceVo.cityRegionCode}">
        	<option value='-1'>请选择</option>
        	<#if payCityRegionCode?exists>
	     		<#list payCityRegionCode as area>
				    <#if area.area_code_id==saver.payFinanceVo.cityRegionCode>   
 ...
 <div class="row-fluid">
	<@div title="开户银行"required=true labelClass="w140" controlsClass="ml160" style="margin-left: 50px;">	
        <@select source=bankCategory target=saver.payFinanceVo.bankCategory name="payBankCategory" class="span10"/>
    </@div>
    <@div title="支行" required=true labelClass="w140" controlsClass="ml160">	
        <select class="span10 m-wrap bank" name="paySubBank" id="paySubBank" value="${saver.payFinanceVo.subBank}">
        	<option value='-1'>请选择</option>
        	<#if SubBankName?exists>
	     		<#list SubBankName as area>
				    <#if area.area_code_id==saver.payFinanceVo.subBank>   
					   	<option value=${area.area_code_id} selected="selected">${area.area_code_name}</option>
				    <#else>
				  	 	<option value=${area.area_code_id}>${area.area_code_name}</option>
				    </#if>
...
<div class="row-fluid">
	<@div title="其他支行"required=true labelClass="w140" controlsClass="ml160" style="margin-left: 50px;">	
        <@text name="payOtherSubBank" value="${saver.payFinanceVo.subBank}" inline=true class="span10" />
    </@div>
</div>  
 <div class="row-fluid">
	<@div title="户名" required=true labelClass="w140" controlsClass="ml160" style="margin-left: 50px;">	
        <@text name="payAccountName" value=saver.account.custName inline=true readonly=true class="span10" />
    </@div>
    <@div title="账号" required=true labelClass="w140" controlsClass="ml160">	
        <@text name="payAccountNum" value=saver.payFinanceVo.accountNum inline=true class="span10"/>
    </@div>
</div>  
<h4 class="form-section">回款账户信息 </h4>   
<div class="row-fluid">  
	<@div title="请选择省" required=true labelClass="w140" controlsClass="ml160" style="margin-left: 50px;">	
        <@select source=areas target=saver.refundFinanceVo.provinceRegionCode name="refundProvinceRegionCode" id="refundProvinceRegionCode" class="span10"/>
    </@div>
	<@div title="请选择市" required=true labelClass="w140" controlsClass="ml160" >	
		<select class="span10 m-wrap bank" name="refundCityRegionCode" id="refundCityRegionCode" value="${saver.refundFinanceVo.cityRegionCode}">
        	<option value='-1'>请选择</option>
 ...
 <div class="row-fluid">
	<@div title="开户银行" required=true  labelClass="w140" controlsClass="ml160" style="margin-left: 50px;">	
        <@select source=bankCategory target=saver.refundFinanceVo.bankCategory name="refundBankCategory" class="span10" />
    </@div>
    <@div title="支行" required=true labelClass="w140" controlsClass="ml160">	
        <select class="span10 m-wrap bank" name="refundSubBank" id="refundSubBank" value="${saver.refundFinanceVo.subBank}">
        	<option value='-1'>请选择</option>
...
<div class="row-fluid">
	<@div title="其他支行" required=true labelClass="w140" controlsClass="ml160" style="margin-left: 50px;">	
        <@text name="refundOtherSubBank" value="${saver.refundFinanceVo.subBank}" inline=true class="span10" />
    </@div>
</div>  
<div class="row-fluid">
	<@div title="户名" required=true labelClass="w140" controlsClass="ml160" style="margin-left: 50px;">	
        <@text name="refundAccountName" value=saver.account.custName inline=true readonly=true class="span10"  />
    </@div>
    <@div title="账号" required=true labelClass="w140" controlsClass="ml160">	
...
<div class="row-fluid" id ="specialCredits" style="height:auto"  >
	<@div title="特殊额度(元)" required=true labelClass="w140" controlsClass="ml160" style="margin-left: 10px;width:410px;">	
...
<div class="row-fluid" id ="specialProfits" style="height:auto" > 
	<@div title="特殊收益(%)" required=true labelClass="w140" controlsClass="ml160" style="margin-left: 10px;width:410px;">	
