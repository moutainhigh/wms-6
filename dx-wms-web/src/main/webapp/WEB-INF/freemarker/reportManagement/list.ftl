                    ...
                    <form action="#" role="form" class="form-horizontal" id="refundForm">
                   	...
                   	<div class="row-fluid">
						<div class="span5 responsive">	
                           ...
                           <label class="control-label">分公司：</label>
                            <div class="controls">
                             <select class="span9 m-wrap" name="branchOfficeQuery" id="branchOfficeQuery" >
								<option value='-1'>请选择</option>
							</select>
                            </div>
                        </div>
                   	...
                   	<div class="row-fluid">
						<div class="span5 responsive">	
							...
							<div class="controls">
								<select class="span12 m-wrap" name="orgIdQuery" id="orgIdQuery" >
									<option value='-1'>请选择</option>
								</select>
	                    	</div>
	                	</div>
                           ...
                           <label class="control-label">大团：</label>
                            <div class="controls">
                             <select class="span9 m-wrap" name="clusterIdQuery" id="clusterIdQuery" >
								<option value='-1'>请选择</option>
							</select>
                            </div>
                        </div>
                   	...
                   	<div class="control-group">
                        ...
                        <div class="span5 responsive" style="margin-left:61.5%">
                            <input type="button" class="btn blue" value="在职管理" id = "jobmanagement">
                    ...
                    <div><div style="float: left;margin-right: 120px;" id="allLenderAmount">出借总额:</div><div id="investment">投资数:</div></div>
                        ...
                        <table id="resultList" class="table table-striped table-bordered table-hover">
                            <thead id="tableName">
                                    ...
                                    <th class='accountName'>账户名</th>
                                    <th class='address'>联系地址</th>
                                    <th class='zipCode'>邮编</th>
                                    <th class='areaName'>区域</th>
                                    <th class='branchOfficeName'>分公司</th>
                                    <th class='orgName'>营业部</th>
...
<div id="waitexper" tabindex="-1"  class="modal hide fade" style="width:300px;text-align:center;position:fixed;left:50%;top:50%;margin-left:width/2;margin-top:height/2"><div class="row-fluid">
        <div class="span12">
            <div class="portlet box blue" style="border-bottom: 0;"><div class="portlet-title">
                ...
                </div>请稍等，正在导出报表<input type="hidden" id="downname" value=${downpathname}></div></div></div></div>
...
<script src="${baseUrl}/assets/js/reportManagement/list.js"></script>
