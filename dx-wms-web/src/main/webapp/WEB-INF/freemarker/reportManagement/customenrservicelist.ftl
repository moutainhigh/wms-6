        ...
        <div class="span12">
            <div class="portlet box blue">
                ...
                <div class="portlet-body">
                    ...
                    <input type="hidden" value=${orgVoId} id="orgVoIdQuery">
                       <div class="row-fluid">
                   	...
                   	<div class="row-fluid">
						...
						<div class="span6 responsive">	
							<label class="control-label" style="width:70px;">团队：</label>
							<div class="controls" style="margin-left: 90px;width: 250px;">
                   	...
                   	<div class="row-fluid">
						...
						<div class="span6 responsive">
                           <label class="control-label">客户经理：</label>
                            <div class="controls">
                             <select class="span9 m-wrap" name="createUserQuery" id="createUserQuery" >
								<option value='-1'>请选择</option>
							</select>
                            </div>
                        </div>
...
<script src="${baseUrl}/assets/js/reportManagement/customenrservicelist.js"></script>
