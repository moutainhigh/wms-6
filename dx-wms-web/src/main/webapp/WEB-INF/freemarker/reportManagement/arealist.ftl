                    ...
                    <form action="#" role="form" class="form-horizontal" id="refundForm">
                       <div class="row-fluid">
						<div class="span5 responsive">	
                           ...
                           <label class="control-label">出借金额：</label>
                            <div class="controls">
                             <select class="span9 m-wrap" name="lenderAmountQuery" id="lenderAmountQuery" style="width:73%">
								<option value='-1'>请选择</option>
                   	...
                   	<div class="row-fluid">
                           ...
                           <label class="control-label">分公司：</label>
                            <div class="controls">
                             <select class="span9 m-wrap" name="branchOfficeQuery" id="branchOfficeQuery" style="width:73.5%">
								<option value='-1'>请选择</option>
                   	...
                   	<div class="span6 responsive">	
							<label class="control-label" style="position: relative;right: 90px;">营业部：</label>
							<div class="controls" style="position: relative;right: 90px;">
								<select class="span9 m-wrap" name="orgIdQuery" id="orgIdQuery" style="width:73%">
									<option value='-1'>请选择</option>
								</select>
	                    	</div>
	                	</div>
...
<script src="${baseUrl}/assets/js/reportManagement/arealist.js"></script>
