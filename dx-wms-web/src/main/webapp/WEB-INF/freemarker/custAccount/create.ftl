    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <div class="portlet box blue" id="form_wizard_1">
                ...
                <div class="portlet-body" style="overflow-y:scroll; width:1018x; height:400px;" >
                            ...
                            <div class="tab-pane active" id="tab1">
                                ...
                                <div class="row-fluid">
                                    ...
                                    <div class="span6 responsive"  style="margin-left: -50px;">
                                        <label class="control-label">姓名(拼音)：<span class="required">*</span></label>
                                        <div class="controls">
                                    ...
                                    <div class="span12 responsive">
                                        ...
                                        <div class="controls">
                                            <div class="span7 responsive">
											    ...
											    <div class="span4 responsive" id="districtRegionCodeDiv">	
                                             ...
                                             <div class="span6 responsive" style="margin-left: -80px;">
                                                <div class="span12 responsive"  id="streetInfoDiv">
                                                    <input type="text" class="m-wrap span10"  placeholder="街道信息" name="streetInfo" id="streetInfo" value="${custAccountApplyVo.custComm.streetInfo}">
                                                </div>
                                            </div>   
                                        </div>
                                    </div>
            ...
            <div class="form-actions clearfix right">
	                ...
	                <a href="javascript:;" class="btn blue button-next"  id="save">
	                 ...
	                 <a href="javascript:;" class="btn blue button-submit"  onclick="doCreateUserAccount()">
	                    	<span id="createUserAccount">确认开户</span> <i class="m-icon-swapright m-icon-white"></i>
	                </a>
