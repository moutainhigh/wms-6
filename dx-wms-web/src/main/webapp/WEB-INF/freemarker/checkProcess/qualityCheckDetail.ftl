        ...
        <div class="span12">
            ...
            <div class="portlet box blue tabbable">
                ...
                <div class="form-actions clearfix txt-right bottom">
	                <a href="javascript:;" id="close_tab" class="btn red button-submit" onclick="doCloseTab('detailModal')">关闭 </a>
	     			<a href="javascript:;" id="submit_tab" class="btn blue button-submit" onclick="doSubmitTab('1','detailModal',this)">提交执委会</a>
					<a href="javascript:;" id="refuse_tab" class="btn blue button-submit" onclick="doSubmitTab('2','detailModal',this)"> 拒绝  </a>	
                </div>
            </div>
        </div>
    </div>
