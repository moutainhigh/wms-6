...
<div class="container-fluid">
    <@head title="新增匹配" home="匹配管理" item={"新增匹配":"/match/add/list.htm"} />
    <@portlet title="新增匹配" formId="queryForm">
	    ...
	    <@line/>
	    <@datatable id="result" items=["客户姓名","身份证","出借编号","出借金额","待匹配金额","出借方式","客户分类","进件日期","操作"] />
	</@portlet>
</div>
...
<script src="${baseUrl}/assets/js/match/add/list.js" type="text/javascript"></script>  
