...
<div class="container-fluid modal-fluid">
    <div class="portlet box blue">
	    <@mPortlet title=custInfo formId="findForm">
	    	<#include findHead>
			<div id="findBody">
...
<script src="${baseUrl}/assets/js/match/find/all/find.js" type="text/javascript"/>