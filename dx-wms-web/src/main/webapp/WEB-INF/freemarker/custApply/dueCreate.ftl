...
<div class="container-fluid">
    ...
    <input type="hidden" name="maxAmount" id="maxAmount" value="${maxAmount}">
    <div class="row-fluid">
        <div class="span12">
            <div class="portlet box blue" id="form_wizard_1">
                            ...
                            <div class="tab-pane active" id="tab2">
                                ...
                                <div class="control-group">
                                    <div class="span6 responsive">
                                        ...
                                        <span class="beyondRmb" id="beyondRmb">
                                         </span>
                                    </div>
                                    <div class="span6 responsive" style="margin-left: -50px;">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="span6 responsive" >
                                        <label class="control-label" style="width: 19%;">回收方式：<span class="required">*</span></label>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="span6 responsive"  style="margin-left: -50px;">
                                        ...
                                        <div class="controls">
                                            <input type="text" maxlength="50"  class="span10 m-wrap" name="refundSubBank" id="refundSubBank" value="${refundCustFinance.subBank}">
                                            <span class="help-inline"></span>
                                        </div>
                                    </div>
                                </div>
                ...
                <!-- 文件上传处 -->  
                    ...
                    <div class="form-actions clearfix">
                        <a href="javascript:;" class="btn blue button-previous" onclick="previous()>
                            <i class="m-icon-swapleft m-icon-white"></i> 上一页
                        </a>
                        <a href="javascript:;" class="btn blue button-next" id = "next">
                                                   下一页 
                        </a>
                         <a href="javascript:;" id="submit_tab" class="btn blue button-submit" onclick="submitToSalesService()">
                                提交销售客服 <i class="m-icon-swapright m-icon-white"></i>
                        </a>
...
<script src="${baseUrl}/assets/js/custApply/dueCreate.js" type="text/javascript"></script> 
