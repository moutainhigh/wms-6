    ...
    <div class="row-fluid">
        <div class="span12"><br>
            ...
            <div class="form-actions clearfix txt-right bottom">
				<input type='button' class='btn red close-modal' value="关闭" id="close" data-dismiss='modal' />
			</div> 
        </div>
    </div>
    </div>
</div>
<script src="${baseUrl}/assets/js/investInfoChange/record.js" type="text/javascript"></script> 
<script>
var base = "${baseUrl}"
</script>
<script>
