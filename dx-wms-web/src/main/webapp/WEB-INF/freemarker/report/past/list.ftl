...
<div class="container-fluid">
    <@head title="往期匹配详情" home="报告管理" item={"往期匹配详情":"/report/past/list.htm"} />
    <@portlet title="往期匹配详情" formId="queryForm">
	    ...
	    <@datatable id="result" items=["checkbox","客户姓名","身份证","出借编号","出借金额","回款匹配金额","出借方式","报告日","投资生效日","操作"] />
	</@portlet>
</div>
...
<script src="${baseUrl}/assets/js/report/past/list.js" type="text/javascript"></script>

<!-- END PAGE LEVEL SCRIPTS -->
<link type="text/css" rel="stylesheet" href="${baseUrl}/assets/css/timer/bootstrap-datetimepicker.min.css">
<script>
	var base = "${baseUrl}";
	var resBase = "${resRoot}";
    (function($) {
