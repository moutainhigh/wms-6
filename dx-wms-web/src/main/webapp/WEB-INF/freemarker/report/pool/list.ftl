...
<div class="container-fluid">
    <@head title="匹配投资生效详情" home="报告管理" item={"匹配投资生效详情":"/report/pool/list.htm"} />
    <@portlet title="匹配投资生效详情" formId="queryForm">
	    ...
	    <@datatable id="result" items=["checkbox","申请日期","出借编号","客户姓名","性别","身份证号","出借方式","出借金额","客户分类","预计出借日期","投资生效日","支付方式","划扣银行","划扣账号","账户名","回款银行","回款账号","账户名","联系地址","邮编","团队主管","客户经理","区域","营业部","接受文件方式","电子邮箱","手机号","账单日","匹配日期","操作"] />
	</@portlet>
</div>
...
<script src="${baseUrl}/assets/js/report/pool/list.js" type="text/javascript"></script>  
